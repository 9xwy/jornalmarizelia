    ...
    <header id="inicio" className="relative overflow-hidden bg-card py-12 md:py-16">
      ...
      <div className="container text-center relative">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3 text-left">
          ...
          <div className="rounded-2xl border border-border bg-background/80 p-4 shadow-sm">
            <p className="font-body text-xs uppercase tracking-wide text-muted-foreground">Gestao rapida</p>
            <p className="font-display text-2xl font-bold text-primary mt-1">Painel admin</p>
            <p className="font-body text-sm text-muted-foreground mt-2">
              Publicacao, edicao e organizacao do conteudo em um fluxo unico com Supabase.
            </p>
          </div>
        </div>
      </div>
